 ...
 */
@Configuration
@ConditionalOnProperty(prefix = "so.serviceprocessor.orchestrationservice", name = "enable", havingValue = "true")
@EnableKafka
public class SpringKafkaOrchestrationServiceConsumerConfig extends AConsumerConfig {
    /**
     ...
     */
    @Bean
    public SpringKafkaOrchestrationServiceConsumerHandler orchestrationServiceConsumerHandler() {
        return new SpringKafkaOrchestrationServiceConsumerHandler();
    }
}
