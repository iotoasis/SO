...
import com.pineone.icbms.so.resources.model.repo.task.*;
 ...
 * @version 
 */
public class TaskRepoInterface extends AMongoRepoInterface  {
	 ...
	 */
	public TaskRepoInterface(String dbName, String collectionName){
		setDB(dbName);
	 ...
	 */
	public void setType(){
		type = modelTYPE(ITaskModel.class);
	}
