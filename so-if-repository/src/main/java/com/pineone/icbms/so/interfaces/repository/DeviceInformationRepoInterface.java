 ...
 * @version 
 */
public class DeviceInformationRepoInterface extends AMongoRepoInterface  {

	
	//Next Version :: load property file 
	
	private static final String db_Name = "ICBMS_SO";
	private static final String collection_Name = "DeviceInformation";
	 ...
	 */
	public DeviceInformationRepoInterface(String dbName, String collectionName){
		setDB(dbName);
	 ...
	 * Constructor 
	 */
	public DeviceInformationRepoInterface(){
		setDB(db_Name);
