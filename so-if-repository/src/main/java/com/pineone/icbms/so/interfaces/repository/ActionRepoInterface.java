...
import com.pineone.icbms.so.resources.model.repo.action.*;

/**
 * Action Model DB Interface 
 * @see MongoConnectionPool.java
 * @Author Yunho.Bae
 * @Date 2015.12.24
 * @version 
 */
public class ActionRepoInterface extends AMongoRepoInterface  {
	 ...
	 */
	public ActionRepoInterface(String dbName, String collectionName){
		setDB(dbName);
	 ...
	 */
	public void setType(){
		type = modelTYPE(IActionModel.class);
	}
