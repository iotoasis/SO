 ...
 * @version 
 */
public class OccurrenceRepoInterface extends AMongoRepoInterface  {

	
	//Next Version :: load property file 
	
	private static final String db_Name = "ICBMS_SO";
	private static final String collection_Name = "Occurrence";
	 ...
	 */
	public OccurrenceRepoInterface(String dbName, String collectionName){
		setDB(dbName);
	 ...
	 * Constructor 
	 */
	public OccurrenceRepoInterface(){
		setDB(db_Name);
