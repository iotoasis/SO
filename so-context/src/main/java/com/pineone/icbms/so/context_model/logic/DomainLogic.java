...
import com.pineone.icbms.so.context_model.proxy.DomainProxy;
...
public class DomainLogic {
    ...
    public static DomainLogic newDomainLogic(){
    ...
    public List<Domain> retrieveDomainList(){
        ...
        // NOTE : SDA 에서 도메인 조회 : List<Domain> domainList = DomainProxy.newDomainProxy().retrieveDomainFromSDA();
