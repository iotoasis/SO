...
/**
 * get Devices about Luminosity in Over Luminosity Location than optimum<BR/>
 * Created by Melvin on 2016. 1. 12..
 */
public class MakeLocationInfoUpLightValueAction extends DefaultAction{

    private final Logger log = LoggerFactory.getLogger(MakeLocationInfoUpLightValueAction.class);
    ...
    public void execute(IGenericContext context) {
        ...
        /**
         * Use DeviceInfoProvider that has SDA Interface(get Over Light Value Device) <BR/>
        ...
        List<DefaultPhysicalDevice> deviceList = deviceInfoProvider.getUpLightValueDevice(location);
