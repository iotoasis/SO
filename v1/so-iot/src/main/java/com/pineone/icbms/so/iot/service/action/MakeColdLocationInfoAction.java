...
/**
 * get Location information that has Under optimum Temperature <BR/>
 * Created by Melvin on 2016. 1. 20..
 */
public class MakeColdLocationInfoAction extends DefaultAction {

    private final Logger log = LoggerFactory.getLogger(MakeColdLocationInfoAction.class);
    ...
    public void execute(IGenericContext context) {
        ...
        /**
         * Use LocationInfoProvider that has SDA Interface(getColdLocation) <BR/>
